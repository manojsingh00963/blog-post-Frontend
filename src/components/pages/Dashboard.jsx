...
function Dashboard() {
  ...
  <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
    <div className="flex items-center justify-center relative z-10 mb-2.5">
      <img
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-EbAu8j31v6X8BgF_aIuhV1t6rqOVET-RuvVQ27NhrLHF3f5P5CIQ6yHSVKZIDsEhaDw&usqp=CAU"
        alt="user-avatar-image"
        className="border-4 border-solid border-gray  rounded-full object-cover "
      />
    </div>
    ...
    John Doe is not a real person's name, but a placeholder name used to refer to an anonymous or unidentified person
    </p>
